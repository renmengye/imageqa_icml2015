...
\icmladdress{${}^1$Department of Computer Science, University of Toronto, Toronto, ON, CANADA\\
...
Our VIS+LSTM and \shortcite{malinowski15}'s
recurrent neural network 
model achieved somewhat 
...
show a few in Figure~\ref{fig:selected_questions} 
and more in Supplementary Materials. Full results are available to view at \url{http://www.cs.toronto.edu/~mren/imageqa/results}.
...
\begin{figure}[h!]
    ...
    \scalebox{0.8}{
    \Tree [.S [.WHNP [.WP \textbf{what} ] ] [.S [.V is ] [.NP [.DET \textbf{the} ] [.N man ] ] [.VP [.V \st{is} ] [.NP [.VBG riding ] [.WHNP [.WP \st{what} ] ] ] ] ] ]}
    \vspace{5mm}
